    ...
    while not stack.isEmpty():
        ...
        if state not in visited:
            ...
            for successor ,action,stepCost in problem.getSuccessors(state):
                ...
                stack.push((successor,newAction,cost+stepCost))
...
def aStarSearch(problem: SearchProblem, heuristic=nullHeuristic):
    ...
    priorityQueue.push((startState,[]),startCost)
    ...
    while not priorityQueue.isEmpty():
        ...
        if state not in visited:
            ...
            for successor,action,cost in problem.getSuccessors(state):
                ...
                if successor not in costs or costs[successor]>newCost-heuristic(successor,problem):
                    costs[successor]=newCost-heuristic(successor,problem)
                    priorityQueue.push((successor,newActions),newCost)
    return[]
